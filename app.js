...
function pseudoCoordsFromZone(zone, seedText = "", spread = 0.01) {
  const centers = {
    "Zone 1": { lng: -80.2175, lat: 26.020 },
    "Zone 2": { lng: -80.2635, lat: 26.040 },
    "Zone 3": { lng: -80.2635, lat: 25.997 },
    "Zone 4": { lng: -80.2775, lat: 26.020 },
    "Zone 5": { lng: -80.2400, lat: 26.020 },
    "Zone 6": { lng: -80.2195, lat: 26.020 },
    "Zone 7": { lng: -80.1995, lat: 26.020 },
    "Zone 8": { lng: -80.2480, lat: 26.020 },
    "Zone 9": { lng: -80.3730, lat: 26.042 },
    "Zone 10": { lng: -80.4660, lat: 26.041 }
  };

  const base = centers[zone] || { lng: -80.280, lat: 26.020 };
  const hash = textHash(seedText || zone);
  const lngOffset = ((hash % 10) - 5) * spread * 0.12;
  const latOffset = (((hash >> 3) % 10) - 5) * spread * 0.12;
